...
class SaleOrder(models.Model):
    ...
    def _get_companies_ten_days_invoicing(self):
        ...
        # always declare pivot_date as a date object because the field invoicing_mode_ten_days_last_execution
        # is a datetime field. If we don't do this and a new pivot_date is calculated,
